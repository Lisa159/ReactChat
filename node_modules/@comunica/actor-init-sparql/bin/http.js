...
if (args._.length !== 1 || args.h || args.help) {
    process.stderr.write('usage: comunica-sparql-http context [-p port] [-t timeout] [-l log-level] [--help]\n' +
...
index_1.newEngineDynamic(options).then(async (engine) => {
    ...
    function handleRequest(request, response) {
        ...
        switch (request.method) {
            ...
            case 'GET':
                return writeQueryResult(request, response, requestUrl.query.query || '', mediaType);
            default:
    ...
    function writeQueryResult(request, response, sparql, mediaType) {
        let eventEmitter;
